/*! Дорожня карта перспективного врегулювання щодо завдань Асоціації — віджет для Webflow.
    ...
    - data-bg  : необов'язково, колір фону під блоком (напр. "#f5f5f5"). За замовчуванням
                 прозорий — блок просто вписується в тло секції, куди його вставили;
                 задавайте лише якщо десь буде видно "рамку".
    ...
    Arial (текст), фіолетовий #8040b0, жовто-зелений акцент #e6f44f, наві #1b2a4a.
...
(function () {
  ...
  function render(root, data) {
    ...
    q("[data-foot]").textContent =
      "Кольорові позначки: зелений — етап опрацьовано, помаранчевий — у роботі, сірий — попереду. " +
      "Показано " + TOTAL + " напрямів за " + SECTIONS.length + " темами." +
      (updated ? "" : " Дані — вбудована копія (таблиця недоступна).");
  }
  ...
  /* ---------- шрифт (Manrope — використовується і на решті сайту) ---------- */
  function ensureFont() {
    if (document.getElementById("uad-roadmap-font") || document.__uadRoadmapFont) return;
    document.__uadRoadmapFont = true;
    var link = document.createElement("link");
    link.id = "uad-roadmap-font";
    link.rel = "stylesheet";
