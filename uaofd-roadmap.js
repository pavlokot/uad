/*! Дорожня карта перспективного врегулювання щодо завдань Асоціації — віджет для Webflow.
    ...
    - data-bg  : необов'язково, колір фону під блоком (напр. "#f4f4f6"), щоб збігався з фоном
                 сторінки і не було видно переходу/рамки. За замовчуванням #f5f5f5 — підправте
                 під точний відтінок вашого сайту прямо в Embed, без переливання файлу.
